...
const Post = ({ publication, post, morePosts }: PostProps) => {
	...
	const seoDescription = post.seo?.description || post.subtitle || post.brief;
	const seoImage = post.ogMetaData?.image || post.coverImage?.url || getAutogeneratedPostOG(post, publication);
	return (
		<>
			<Head>
