...
export default function Index(
	...
	const seoTitle = publication.displayTitle || publication.title || `${publication.author.name}'s Blog`;
	const seoDescription = publication.descriptionSEO || publication.title || `${publication.author.name}'s Blog`;
	const seoImage = publication.ogMetaData.image || getAutogeneratedPublicationOG(publication);
